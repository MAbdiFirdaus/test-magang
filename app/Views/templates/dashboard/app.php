        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link <?= (preg_match('/^\/employees$/', $current_url)) ? 'active' : ''; ?>" href="/employees" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link <?= (preg_match('/^\/leave_requests$/', $current_url)) ? 'active' : ''; ?>" href="/leave_requests" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link <?= (preg_match('/^\/attendance$/', $current_url)) ? 'active' : ''; ?>" href="/job_openings/table" aria-expanded="false">
                <span>
                  <i class="ti ti-calendar"></i>
                </span>
